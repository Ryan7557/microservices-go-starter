...
func (r *RabbitMQ) ConsumeMessages(queueName string, handler MessageHandler) error {
	...
	err := r.Channel.Qos(
		...
		false, // global: Apply prefetch count to each consumer individually
	)
	if err != nil {
...
func (r *RabbitMQ) setupDeadLetterExchange() error {
	...
	if err != nil {
		return fmt.Errorf("failed to declare dead letter queue: %v")
	}
...
func (r *RabbitMQ) setupExchangesAndQueues() error {
	// First setup the DLQ(Dead Letter Queue) exchange and queue
